...
- 最终交付必须回写到 `product-spec-context.md`，不得依赖外部记忆作为唯一事实来源。
- coder/evaluator 交接时，默认只传递 `product-spec-context.md` 路径与目标标题，不传递冗余上下文正文。
...
~~~
# 📘 产品规格与上下文文档 (Product Spec & Context) - [项目名称]
