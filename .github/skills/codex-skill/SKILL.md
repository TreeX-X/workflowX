---
name: codex-skill
description: Leverage OpenAI Codex/GPT models for autonomous code implementation. Triggers: "codex", "use gpt", "gpt-5.3-Codex", "let openai", "full-auto", "用codex", "让gpt实现".
