...
When generating and maintaining Hybrid Docs documents, **you must read and strictly follow the `.codex/skills/planner-prd-playbook/hybrid-template.md` file in the same directory as the content skeleton.**
